...
#        json_bootorder.append(json.dumps(bootoption))
    json_data = {
      "BootOrder" : bootorder
    }
    json_data = {
...
#    json_data = json.dump({"BootOrder": json_bootorder})
#    json_data = json.dump({"Boot": json_data})
...
if display_help:
    ...
    print(" -H, --host      -- Redfish host. Must include protocol, e.g. https://host", file=sys.stderr)
